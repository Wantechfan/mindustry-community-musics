...
2. launch = Avangard (by Lonown)
3. game1 = Shiawese (by Dion Timmer, requested by @copper_in_mindustry)
4. game2 = Ai Đưa Em Về (by TIA, requested by @copper_in_mindustry)
5. game3 = Ultimate Comrade Music You Should Hear.
6. game4 = Kerosene (by Crystal Castles)
7. game5 = Memory Reboot (by VØJ)
